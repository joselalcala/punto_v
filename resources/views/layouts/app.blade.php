...
<head>
    ...
    <meta name="description" content="Panel administrativo para un sistema de punto de venta." />
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            notificationIcon.addEventListener('click', function() {
                fetch("{{ route('notifications.markAsRead') }}", {
                    ...
                    .catch(error => console.error('Error al marcar notificaciones como leidas:', error));
            });
